  ...
  return (
    <>
      <div className='w-full flex justify-between items-center font-semibold'>
        ...
        <img onClick={()=>navigate(-1)} className='w-8 bg-black p-2 rounded-2xl cursor-pointer' src={asset.arrow_left} alt=''/>
        <img onClick={()=>navigate(1)} className='w-8 bg-black p-2 rounded-2xl cursor-pointer' src={asset.arrow_right} alt=''/>
        </div>
